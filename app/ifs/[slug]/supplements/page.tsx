...
import { getIfStories, getStoryDetail } from "../../../../lib/content-loader";
...
export default async function IfStorySupplementsPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  return (
    ...
    >
      <SupplementsClient story={story} baseRoute="/ifs" />
    </Suspense>
  );
}
